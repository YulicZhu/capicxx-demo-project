...
,          myStatus_(*this, 0x80f2, CommonAPI::SomeIP::event_id_t(0x80f2), false, false, std::make_tuple(static_cast< CommonAPI::SomeIP::IntegerDeployment<int32_t>* >(nullptr)))
    {
    }
    ...
    E03MethodsSomeIPProxy::MyStatusEvent& E03MethodsSomeIPProxy::getMyStatusEvent() {
        ...
        void E03MethodsSomeIPProxy::foo(const int32_t &_x1, const std::string &_x2, CommonAPI::CallStatus &_internalCallStatus, E03Methods::stdErrorTypeEnum &_error, int32_t &_y1, std::string &_y2, const CommonAPI::CallInfo *_info) {
